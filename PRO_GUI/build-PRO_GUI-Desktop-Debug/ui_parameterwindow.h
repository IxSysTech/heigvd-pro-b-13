...
public:
    ...
    void setupUi(QMainWindow *ParameterWindow)
    {
        ...
        ParameterWindow->resize(700, 390);
        ParameterWindow->setMinimumSize(QSize(700, 390));
        ParameterWindow->setMaximumSize(QSize(700, 405));
    ...
    void retranslateUi(QMainWindow *ParameterWindow)
    {
        ...
        btnRun->setText(QApplication::translate("ParameterWindow", "Run Simuelation", nullptr));
    } // retranslateUi
